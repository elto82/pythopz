...
class GameManager:
    """Contiene toda la capa comercial para hacer el juego."""
    ...
    def _render_frame(self):
        """Renderiza y actualiza la escena principal."""
    ...
    def _render_level(self):
        """Muestra el nivel actual en la escena."""
        print('=' * 15 + f'   LEVEL {len(self.word_indexes_used)}   ' + '=' * 15)

    def _set_game_level(self):
        """Establece la palabra para iniciar el juego."""
